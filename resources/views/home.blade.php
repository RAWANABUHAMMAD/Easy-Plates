            ...
            <div class="carousel-item">
                ...
                <div class="carousel-caption d-md-block text-start">
                    ...
                    <ul class="mb-0 mt-4">
                        ...
                        <li class="d-inline-block"><a class="button button_1" href="/contact">Contact Us <i class="fa fa-long-arrow-right ms-2"></i></a></li>
                    </ul>
                </div>
            </div>
...
<section id="spec" class="pt-5 pb-5 bg-light">
  <div class="container-xl">
      <div class="row justify-content-center center_h1">
          <div class="col-md-2 col-sm-6">
              <div class="center_h1i text-center">
                  
                    <img class="img-fluid rounded-circle" alt="abc" src="{{ asset('assest1/image/Appetizers.jpg') }}" style="width: 200px; height: 200px;">


                  </a>
                  <h6 class="mb-0 mt-2">
                    <a href="/recipe" style="font-weight: bold;">APPETIZER</a>
                  </h6>
              </div>
          </div>
          ...
          <div class="col-md-2 col-sm-6">
              <div class="center_h1i text-center">
                    ...
                    <img class="img-fluid rounded-circle" alt="abc" src="{{ asset('assest1/image/magloba.jpg') }}" style="width: 200px; height: 200px;">

                  </a>
                  <h6 class="mb-0 mt-2">
                    <a href="/recipe" style="font-weight: bold;">MAIN DISH</a>
                  </h6>
              </div>
          </div>
      </div>
    ...
    <div class="row row-cols-1 row-cols-md-3 popular_2 popular_2o">
      ...
      <div class="col">
        <div class="popular_2_left position-relative">
          <div class="popular_2_left1">
            <a href="#">
              <img src="{{ asset('assest1/image/lamb_meat.jpg') }}" class="img-fluid fixed-img" alt="abc">
            </a>
          </div>
      ...
      <div class="col">
        <div class="popular_2_left position-relative">
          <div class="popular_2_left1">
            <a href="#">
              <img src="{{ asset('assest1/image/Beef Lasagna.jpg') }}" class="img-fluid fixed-img" alt="abc">
            </a>
          </div>
          <div class="popular_2_left3 position-absolute top-0 w-100 pt-3">
            <div class="d-flex justify-content-between align-items-center">
      ...
      <div class="col">
        <div class="popular_2_left position-relative">
          <div class="popular_2_left1">
            <a href="#">
              <img src="{{ asset('assest1/image/mansaf2.jpg') }}" class="img-fluid fixed-img" alt="abc">
            </a>
          </div>
          <div class="popular_2_left3 position-absolute top-0 w-100 pt-3">
            <div class="d-flex justify-content-between align-items-center">
    ...
    <div class="row row-cols-1 row-cols-md-1 popular_2 popular_2o">
      <div class="col">
        <div class="popular_2_left position-relative">
          <div class="popular_2_left1">
            <a href="#">
              <img src="{{ asset('assest1/image/latest.jpg') }}" class="img-fluid" alt="abc">
            </a>
          </div>
        </div>
      </div>
